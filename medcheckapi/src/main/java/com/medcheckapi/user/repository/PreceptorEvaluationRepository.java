...
public interface PreceptorEvaluationRepository extends JpaRepository<PreceptorEvaluation, Long> {
    ...
    List<PreceptorEvaluation> findByAlunoAndDisciplineAndWeekNumber(User aluno, Discipline discipline, Integer weekNumber);
    List<PreceptorEvaluation> findByAlunoAndWeekNumberAndDisciplineIsNull(User aluno, Integer weekNumber);
}
